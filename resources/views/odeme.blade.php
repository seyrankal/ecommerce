                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control kredikarti" id="kart_numarasi" name="kart_numarasi"
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    Ay
                                    <select name="son_kullanma_tarihi_ay" id="son_kullanma_tarihi_ay" class="form-control"
                                        required>
                                        <option>1</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    Yıl
                                    <select id="son_kullanma_tarihi_yil" name="son_kullanma_tarihi_yil" class="form-control"
                                        required>
                                        <option>2017</option>
                                    </select>
                                </div>
